...
(function($) {
	function FlightIndicator( placeholder, type, options ) {
		...
		placeholder.each(function(){
			switch(type){
				case 'heading':
					$(this).html('<div class="instrument heading"><div class="heading box"><img src="' + settings.img_directory + 'heading_yaw2.svg" class="box" alt="" /></div><div class="mechanics box"><img src="' + settings.img_directory + 'heading_mechanics.svg" class="box" alt="" /></div></div>');
				...
				break;
				default:
					$(this).html('<div class="instrument attitude"><div class="roll box"><div class="pitch box"><img src="' + settings.img_directory + 'horizon_ball2.svg" class="box" alt="" /></div><img src="' + settings.img_directory + 'horizon_circle2.svg" class="box" alt="" /></div><div class="mechanics box"><img src="' + settings.img_directory + 'horizon_mechanics2.svg" class="box" alt="" /><img src="' + settings.img_directory + 'fi_circle2.svg" class="box" alt="" /></div></div>');
